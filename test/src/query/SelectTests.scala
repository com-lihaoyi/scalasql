  ...
  def tests = Tests {
    ...
    test("joins"){
      ...
      test("selfJoin2") - checker(Buyer.select.joinOn(Buyer)(_.id !== _.id)).expect(
        ...
        """,
        value =  Vector(
          (Buyer(1, "James Bond", "2001-02-03"), Buyer(2, "叉烧包", "1923-11-12")),
          (Buyer(1, "James Bond", "2001-02-03"), Buyer(3, "Li Haoyi", "1965-08-09")),
          (Buyer(2, "叉烧包", "1923-11-12"), Buyer(1, "James Bond", "2001-02-03")),
          (Buyer(2, "叉烧包", "1923-11-12"), Buyer(3, "Li Haoyi", "1965-08-09")),
          (Buyer(3, "Li Haoyi", "1965-08-09"), Buyer(1, "James Bond", "2001-02-03")),
          (Buyer(3, "Li Haoyi", "1965-08-09"), Buyer(2, "叉烧包", "1923-11-12"))
        )
      )
