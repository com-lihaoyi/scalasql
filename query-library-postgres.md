# postgres Reference Query Library

This page contains example queries for the `postgres` database, taken
from the ScalaSql test suite. You can use this as a reference to see
what kinds of operations ScalaSql supports when working on `postgres`,
