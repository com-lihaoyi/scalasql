  ...
  def tests = Tests {
      ...
      query = Text {
        AdvancedData.insert.batched(
          ...
          (
            ...
            LocalDateTime.of(2024, 1, 3, 14, 45),
            LocalDate.of(2024, 1, 3),
            true,
            Some(""),
            Some(BigDecimal("0.0001")),
            "not empty",
            1,
            777777777777L
          ),
          (
            ...
            BigDecimal("0.00"),
            LocalDateTime.of(2024, 1, 4, 15, 0),
          ...
          (
            ...
            BigDecimal("0.00"),
            LocalDateTime.of(2024, 1, 5, 16, 15),
    ...
    test("countComplexTypes") - {
      ...
      test("bigDecimalCount") - checker(
        ...
        sql =
          "SELECT COUNT(advanced_data0.big_decimal_value) AS res FROM advanced_data advanced_data0",
        value = 5
      )
      ...
      test("bigDecimalCountDistinct") - checker(
        ...
        sql =
          "SELECT COUNT(DISTINCT advanced_data0.big_decimal_value) AS res FROM advanced_data advanced_data0",
    ...
    test("countWithBooleanExpressions") - {
      ...
      test("booleanColumnCountDistinct") - checker(
        ...
        sql =
          "SELECT COUNT(DISTINCT advanced_data0.boolean_flag) AS res FROM advanced_data advanced_data0",
    ...
    test("countWithEmptyStringsAndZeros") - {
      test("emptyStringCount") - checker(
        ...
        sql =
          "SELECT COUNT(advanced_data0.empty_string_field) AS res FROM advanced_data advanced_data0",
      ...
      test("emptyStringCountDistinct") - checker(
        ...
        sql =
          "SELECT COUNT(DISTINCT advanced_data0.empty_string_field) AS res FROM advanced_data advanced_data0",
      ...
      test("zeroValueCountDistinct") - checker(
        ...
        sql =
          "SELECT COUNT(DISTINCT advanced_data0.zero_value) AS res FROM advanced_data advanced_data0",
        value = 3 // 0, 1, 2
      )
    }
    ...
    test("countWithStringExpressions") - {
      test("stringConcatCount") - checker(
        ...
        sqls = Seq(
          """SELECT COUNT((advanced_data0.optional_string || ?)) AS res
                FROM advanced_data advanced_data0
                WHERE (advanced_data0.optional_string IS NOT NULL)""",
          """SELECT COUNT(CONCAT(advanced_data0.optional_string, ?)) AS res
                FROM advanced_data advanced_data0
                WHERE (advanced_data0.optional_string IS NOT NULL)"""
        ),
      ...
      test("stringLengthCount") - checker(
        ...
        sql =
          "SELECT COUNT(DISTINCT LENGTH(advanced_data0.empty_string_field)) AS res FROM advanced_data advanced_data0",
    ...
    test("countWithComplexGroupBy") - {
      ...
      test("groupByDateWithCountBigDecimal") - checker(
        query =
          Text { AdvancedData.select.groupBy(_.date)(agg => agg.countBy(_.optionalBigDecimal)) },
        sql =
          """SELECT advanced_data0.date AS res_0, COUNT(advanced_data0.optional_big_decimal) AS res_1
                FROM advanced_data advanced_data0
