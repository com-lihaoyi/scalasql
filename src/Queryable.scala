...
object Queryable {
  trait Simple[-Q, R] extends Queryable[Q, R]
  object Simple {
    ...
    implicit def Tuple2Queryable[Q1, Q2, R1, R2](
        implicit q1: Queryable.Simple[Q1, R1],
        q2: Queryable.Simple[Q2, R2]
    ): Queryable.Simple[(Q1, Q2), (R1, R2)] = {
      new Queryable.Simple.TupleNQueryable(
    ...
    implicit def Tuple3Queryable[Q1, Q2, Q3, R1, R2, R3](
        implicit q1: Queryable.Simple[Q1, R1],
        q2: Queryable.Simple[Q2, R2],
        q3: Queryable.Simple[Q3, R3]
    ): Queryable.Simple[(Q1, Q2, Q3), (R1, R2, R3)] = {
      new Queryable.Simple.TupleNQueryable(
    ...
    implicit def Tuple4Queryable[Q1, Q2, Q3, Q4, R1, R2, R3, R4](
        ...
        q2: Queryable.Simple[Q2, R2],
        q3: Queryable.Simple[Q3, R3],
        q4: Queryable.Simple[Q4, R4]
    ): Queryable.Simple[(Q1, Q2, Q3, Q4), (R1, R2, R3, R4)] = {
      new Queryable.Simple.TupleNQueryable(
    ...
    implicit def Tuple5Queryable[Q1, Q2, Q3, Q4, Q5, R1, R2, R3, R4, R5](
        ...
        q3: Queryable.Simple[Q3, R3],
        q4: Queryable.Simple[Q4, R4],
        q5: Queryable.Simple[Q5, R5]
    ): Queryable.Simple[(Q1, Q2, Q3, Q4, Q5), (R1, R2, R3, R4, R5)] = {
      new Queryable.Simple.TupleNQueryable(
    ...
    implicit def Tuple6Queryable[Q1, Q2, Q3, Q4, Q5, Q6, R1, R2, R3, R4, R5, R6](
        ...
        q4: Queryable.Simple[Q4, R4],
        q5: Queryable.Simple[Q5, R5],
        q6: Queryable.Simple[Q6, R6]
    ): Queryable.Simple[(Q1, Q2, Q3, Q4, Q5, Q6), (R1, R2, R3, R4, R5, R6)] = {
      new Queryable.Simple.TupleNQueryable(
        t =>
          Seq(
            q1.walk(t._1),
    ...
    ): Queryable.Simple[Option[Q], Option[R]] = new Queryable.Simple[Option[Q], Option[R]] {
