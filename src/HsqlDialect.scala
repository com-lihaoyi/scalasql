...
object HsqlDialect extends SqliteDialect {
...
trait HsqlDialect extends Dialect {
  override implicit def ExprStringOpsConv(v: Expr[String]): HsqlDialect.ExprStringOps =
    new HsqlDialect.ExprStringOps(v)
}
